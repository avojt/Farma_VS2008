...
Public Class frmOjUnos
    ...
    Private Sub frmOjUnos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        pocetak()
        popuni_gradove()
        popuni_opstine()
        popuni_mesta()
    ...
    Private Sub snimi()
        ...
        If CN.State = ConnectionState.Open Then
            ...
            With CM
                ...
                .CommandText = "app_organizacione_jedinice_add"
