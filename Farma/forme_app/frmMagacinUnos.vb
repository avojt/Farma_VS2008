...
Public Class frmMagacinUnos
    ...
    Private Sub frmMagacinUnos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        pocetak()
    End Sub

    Private Sub pocetak()
        txtSifra.Text = "" '"00" & CStr(Nadji_rb(Imena.tabele.rm_kategorizacija.ToString))
        txtNaziv.Text = ""
        chkVodjenjeZaliha.Checked = False
    ...
    Private Sub popuni_vrste_magacina()
        ...
        If cmbVrstaMagacin.Items.Count > 0 Then
            cmbVrstaMagacin.SelectedIndex = 0
        End If
        CM.Dispose()
        CN.Close()
