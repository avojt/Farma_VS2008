...
Public Class frmKontoUnos
    ...
    Private Sub frmKontoUnos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        pocetak()
    End Sub

    Private Sub pocetak()
        txtKonto.Text = "" '"00" & CStr(Nadji_rb(Imena.tabele.rm_kategorizacija.ToString))
        txtNaziv.Text = ""
        chkDevizni.Checked = False
        chkDozvoljeno.Checked = False
    End Sub
