...
Public Class rptMagInterniPrenos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMagInterniPrenos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMagInterniPrenos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMagInterniPrenos = New rptMagInterniPrenos
        rpt.Site = Me.Site
        Return rpt
    End Function
