...
Public Class rptAnalitika_kartica
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAnalitika_kartica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAnalitika_kartica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAnalitika_kartica = New rptAnalitika_kartica
        rpt.Site = Me.Site
        Return rpt
    End Function
