...
Public Class rptOJ
    ...
    Private Sub rptOJ_InitReport(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.InitReport
        Me.VerifyDatabase()
