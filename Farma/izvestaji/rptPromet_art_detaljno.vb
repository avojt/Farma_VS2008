...
Public Class rptPromet_art_detaljno
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPromet_art_detaljno.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPromet_art_detaljno
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPromet_art_detaljno = New rptPromet_art_detaljno
        rpt.Site = Me.Site
        Return rpt
    End Function
