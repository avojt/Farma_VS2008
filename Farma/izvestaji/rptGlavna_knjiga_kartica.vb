...
Public Class rptGlavna_knjiga_kartica
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptGlavna_knjiga_kartica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGlavna_knjiga_kartica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGlavna_knjiga_kartica = New rptGlavna_knjiga_kartica
        rpt.Site = Me.Site
        Return rpt
    End Function
