...
Public Class rptMagacinPopisnaLista
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMagacinPopisnaLista.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMagacinPopisnaLista
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMagacinPopisnaLista = New rptMagacinPopisnaLista
        rpt.Site = Me.Site
        Return rpt
    End Function
