...
Public Class rptLab_dn_trebovanje
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLab_dn_trebovanje.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLab_dn_trebovanje
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLab_dn_trebovanje = New rptLab_dn_trebovanje
        rpt.Site = Me.Site
        Return rpt
    End Function
