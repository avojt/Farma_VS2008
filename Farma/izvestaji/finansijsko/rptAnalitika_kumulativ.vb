...
Public Class rptAnalitika_kumulativ
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAnalitika_kumulativ.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAnalitika_kumulativ
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAnalitika_kumulativ = New rptAnalitika_kumulativ
        rpt.Site = Me.Site
        Return rpt
    End Function
