...
Public Class rptPov_konta_pregled_otvorenih
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPov_konta_pregled_otvorenih.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPov_konta_pregled_otvorenih
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPov_konta_pregled_otvorenih = New rptPov_konta_pregled_otvorenih
        rpt.Site = Me.Site
        Return rpt
    End Function
