...
Public Class rptKartica_po_analitici
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptKartica_po_analitici.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptKartica_po_analitici
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKartica_po_analitici = New rptKartica_po_analitici
        rpt.Site = Me.Site
        Return rpt
    End Function
