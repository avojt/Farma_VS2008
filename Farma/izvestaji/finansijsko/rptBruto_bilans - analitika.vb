...
Public Class rptBruto_bilans___analitika
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptBruto_bilans - analitika.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBruto_bilans___analitika
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBruto_bilans___analitika = New rptBruto_bilans___analitika
        rpt.Site = Me.Site
        Return rpt
    End Function
