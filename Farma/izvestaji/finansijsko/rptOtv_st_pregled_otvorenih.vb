...
Public Class rptOtv_st_pregled_otvorenih
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptOtv_st_pregled_otvorenih.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOtv_st_pregled_otvorenih
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOtv_st_pregled_otvorenih = New rptOtv_st_pregled_otvorenih
        rpt.Site = Me.Site
        Return rpt
    End Function
