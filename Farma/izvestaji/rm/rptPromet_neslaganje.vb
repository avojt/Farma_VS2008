...
Public Class rptPromet_neslaganje
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPromet_neslaganje.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPromet_neslaganje
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPromet_neslaganje = New rptPromet_neslaganje
        rpt.Site = Me.Site
        Return rpt
    End Function
