...
Public Class rptPromet_mag_stanje
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPromet_mag_stanje.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPromet_mag_stanje
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPromet_mag_stanje = New rptPromet_mag_stanje
        rpt.Site = Me.Site
        Return rpt
    End Function
