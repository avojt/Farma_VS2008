...
Public Class rptSpecifikacija_ulaz
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSpecifikacija_ulaz.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSpecifikacija_ulaz
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSpecifikacija_ulaz = New rptSpecifikacija_ulaz
        rpt.Site = Me.Site
        Return rpt
    End Function
