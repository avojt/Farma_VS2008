...
Public Class rptPromet_art_kumulativ
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPromet_art_kumulativ.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPromet_art_kumulativ
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPromet_art_kumulativ = New rptPromet_art_kumulativ
        rpt.Site = Me.Site
        Return rpt
    End Function
