...
Public Class rptSpecifikacija_izlaz
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSpecifikacija_izlaz.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSpecifikacija_izlaz
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSpecifikacija_izlaz = New rptSpecifikacija_izlaz
        rpt.Site = Me.Site
        Return rpt
    End Function
