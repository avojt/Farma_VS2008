...
Public Class rptIzlazni_Dokument
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptIzlazni_Dokument.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIzlazni_Dokument
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIzlazni_Dokument = New rptIzlazni_Dokument
        rpt.Site = Me.Site
        Return rpt
    End Function
