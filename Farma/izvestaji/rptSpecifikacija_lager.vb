...
Public Class rptSpecifikacija_lager
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSpecifikacija_lager.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSpecifikacija_lager
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSpecifikacija_lager = New rptSpecifikacija_lager
        rpt.Site = Me.Site
        Return rpt
    End Function
