...
Public Class rptSpecifikacija_nivelacija
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSpecifikacija_nivelacija.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSpecifikacija_nivelacija
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSpecifikacija_nivelacija = New rptSpecifikacija_nivelacija
        rpt.Site = Me.Site
        Return rpt
    End Function
