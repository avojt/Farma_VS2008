...
Public Class cntPovezana_konta_ispravke
    ...
    Shared sql_start As String = "SELECT * FROM dbo.fn_povezana_konta"
    ...
    Private Sub cntPovezana_konta_ispravke_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub filter_duguje()
        ...
        Else
            If upit <> "" Then
                sql = sql_start_nalog & " WHERE " & upit & " and stavka_duguje <> 0 and stavka_konto = N'" & RTrim(cmbKontoOD.Text) & "' and stavka_konto_povezan = 0"
            Else
                sql = sql_start_nalog
            End If
        End If
                ...
                While DR.Read
                    If preg_povezanih Then
                        ...
                        If DR.Item("id_dug") <> 0 Then
                            ...
                            podatak.SubItems.Add(DR.Item("id_pk"))
    ...
    Private Sub filter_potrazuje()
        ...
        Else
            If upit <> "" Then
                sql = sql_start_nalog & " WHERE " & upit & " and stavka_potrazuje <> 0 and stavka_konto = N'" & RTrim(cmbKontoDO.Text) & "' and stavka_konto_povezan = 0"
            Else
                sql = sql_start_nalog
            End If
        End If
    ...
    Private Sub btnPotrazuje_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPotrazuje.Click
        ...
        If cmbKontoDO.Text <> "" Then
            upit_kontoDO = "konto = N'" & RTrim(cmbKontoDO.Text) & "'"
        Else
            upit_kontoDO = ""
        End If
