...
Public Class cntNalog_print
    ...
    Private Sub cntNalog_print_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        popuni_vrste()
    ...
    Private Sub filter()
        ...
        If upit_zakljcene_nadanasnji <> "" And upit <> "" Then
            upit = upit & " and " & upit_zakljcene_nadanasnji
        Else
            If upit_zakljcene_nadanasnji <> "" Then upit = upit_zakljcene_nadanasnji
        End If
    ...
    Private Sub rbtZaklj_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbtZaklj.CheckedChanged
        Select Case rbtZaklj.Checked
            Case True
                rbtNezaklj.Checked = False
                rbtZaklj_nadanasnji.Checked = False
    ...
    Private Sub rbtZaklj_nadanasnji_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles rbtZaklj_nadanasnji.CheckedChanged
        Select Case rbtZaklj_nadanasnji.Checked
            Case True
                rbtNezaklj.Checked = False
                rbtZaklj.Checked = False
                upit_zakljcene_nadanasnji = "fn_nalog_head.nal_proknjizen = 1 and " & _
                                            "fn_nalog_head.nal_proknjizen_datum = '" & _
                                                Today.Month.ToString & "/" & _
                                                Today.Day.ToString & "/" & _
                                                Today.Year.ToString & "'"
            Case False
                upit_zakljcene_nadanasnji = ""
        End Select
        filter()
    End Sub
