...
Public Class cntInterniPrenos_search
    ...
    Private Sub cntInterniPrenos_search_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        popuni_Magacine()
        ...
        If sql <> "" Then
            ...
            If CN.State = ConnectionState.Open Then
                ...
                While DR.Read
                    ...
                    podatak.SubItems.Add(DR.Item("int_pr_ukupno").ToString)
