...
Public Class cntKalkulacija_print
    ...
    Private Sub cntKalkulacija_print_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        popuni_Magacine()
        popuni_dobavljace()
        ...
        If sql <> sql_start Then
            ...
            If CN.State = ConnectionState.Open Then
                ...
                While DR.Read
                    ...
                    podatak.SubItems.Add(DR.Item("kalk_svega").ToString)
