...
Public Class cntPovracaj_roba_print
    ...
    Private Sub cntPovracaj_roba_print_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        popuni_Magacine()
        popuni_dobavljace()
    ...
    Private Sub filter()
        ...
        sql = sql_start
        If upit <> "" Then
            sql += " WHERE " & upit & " ORDER BY rm_povracaj_robe_head.pov_robe_datum DESC," & _
