...
Public Class cntNivelacija_search
    ...
    Shared sql_start As String = _
                "SELECT " & _
                    ...
                    "dbo.rm_nivelacije_head.razlika_uceni, dbo.rm_nivelacije_head.unesena, " & _
                    "dbo.rm_nivelacije_head.automatska, " & _
                    "dbo.rm_nivelacije_head.vezni_dokument_broj, dbo.rm_magacin.magacin_naziv " & _
    ...
    Private Sub cntNivelacija_search_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        popuni_Magacine()
    ...
    Private Sub filter()
        ...
        sql = sql_start
        If upit <> "" Then
            sql += " WHERE " & upit & " ORDER BY rm_nivelacije_head.broj DESC" '& _
            '" rm_nivelacije_head.broj DESC"
        End If
    ...
    Shared Sub Lista()
        ...
        If sql <> "" Then
            ...
            If CN.State = ConnectionState.Open Then
                ...
                While DR.Read
                    Dim podatak As New ListViewItem(CStr(DR.Item("broj")))
                    ...
                    'podatak.SubItems.Add(DR.Item("unesena").ToString)
                    'podatak.SubItems.Add(DR.Item("automatska").ToString)
    ...
    Private Sub rbtZaklj_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbtZaklj.CheckedChanged
        Select Case rbtZaklj.Checked
            Case True
                ...
                upit_zakljcene = "rm_nivelacije_head.unesena = 1"
            Case False
                upit_zakljcene = ""
        End Select
        filter()
    ...
    Private Sub rbtNezaklj_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbtNezaklj.CheckedChanged
        Select Case rbtNezaklj.Checked
            Case True
                rbtZaklj.Checked = False
                upit_zakljcene = "rm_nivelacije_head.unesena = 0"
            Case False
                upit_zakljcene = ""
        End Select
        filter()
    ...
    Private Sub chkSve_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkSve.CheckedChanged
        ...
        Select Case chkSve.CheckState
            Case CheckState.Checked
                ...
                sql = sql_start + " ORDER BY rm_nivelacije_head.datum DESC"
                'filter()
                Lista()
    ...
    Private Sub txtBroj_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtBroj.KeyPress
        If e.KeyChar = Chr(13) Then
            If txtBroj.Text <> "" Then
                upit_broj = "rm_nivelacije_head.broj = " & txtBroj.Text '& "%'"
            Else
                upit_broj = ""
            End If
            filter()
    ...
    Private Sub datDatum_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles datDatum.KeyPress
        If e.KeyChar = Chr(13) Then
            upit_datum = "rm_nivelacije_head.datum = '" & _
