...
Public Class cntKnjizZaduzUlaz_search
    ...
    Shared sql_start As String = _
                ...
                "rm_magacin ON rm_knjizno_zaduzenje_ulaz_head.id_magacina = rm_magacin.id_magacin LEFT OUTER JOIN " & _
    ...
    Private Sub cntKnjizZaduzUlaz_search_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        popuni_Magacine()
        popuni_dobavljace()
