...
Public Class cntPopis_search
    ...
    Shared sql_start As String = _
                "SELECT DISTINCT dbo.rm_popis_head.pop_broj, dbo.rm_popis_head.pop_datum, " & _
    ...
    Private Sub cntPopis_search_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        popuni_Magacine()
    ...
    Private Sub filter()
        ...
        sql = sql_start
        If upit <> "" Then
            sql += " WHERE " & upit & " ORDER BY rm_popis_head.pop_datum DESC," & _
                                                 " rm_popis_head.pop_broj DESC"
        End If
    ...
    Shared Sub Lista()
        ...
        If sql <> "" Then
            ...
            If CN.State = ConnectionState.Open Then
                ...
                While DR.Read
                    Dim podatak As New ListViewItem(CStr(DR.Item("pop_broj")))

                    podatak.SubItems.Add(DR.Item("pop_datum"))
    ...
    Private Sub chkSve_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkSve.CheckedChanged
        ...
        Select Case chkSve.CheckState
            Case CheckState.Checked
                ...
                sql = sql_start + " ORDER BY rm_popis_head.pop_datum DESC"
                'filter()
                Lista()
    ...
    Private Sub txtBroj_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtBroj.KeyPress
        If e.KeyChar = Chr(13) Then
            If txtBroj.Text <> "" Then
                upit_broj = "rm_popis_head.pop_broj = " & txtBroj.Text '& "%'"
            Else
                upit_broj = ""
            End If
            filter()
    ...
    Private Sub datDatum_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles datDatum.KeyPress
        If e.KeyChar = Chr(13) Then
            upit_datum = "rm_popis_head.pop_datum = '" & _
